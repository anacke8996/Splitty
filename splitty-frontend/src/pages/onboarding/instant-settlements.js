    ...
    return (
        <AnimatedContainer>
            ...
            >
                ...
                <MainIconContainer>
                    <IconBackground>
                        <FlashOnIcon sx={{ fontSize: 48, color: '#ffffff' }} />
                    </IconBackground>
                    <IconPulse />
                </MainIconContainer>
                ...
                <Box sx={{ mb: 4 }}>
                    <GradientTitle>
                        Instant <span className="gradient-text">Settlements</span>
                    </GradientTitle>
                ...
                <Box sx={{ mb: 6 }}>
                    ...
                    >
                        Track payments and settle debts instantly. Know who owes what and when payments are made.
                    </Typography>

                    {/* Feature highlights */}
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
                        {["Payment tracking", "Instant alerts", "Smart reminders", "Easy settlement"].map(
                            (feature, index) => (
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1 }}>
                    {[0, 1, 2].map((step) => (
                        <ProgressDot key={step} isActive={step === 2} />
                    ))}
                </Box>
            </Box>
        </AnimatedContainer>
