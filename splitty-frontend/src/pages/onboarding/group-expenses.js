...
export default function GroupExpenses() {
    ...
    const features = [
        { icon: GroupIcon, text: "Share with friends" },
        { icon: ReceiptIcon, text: "Upload receipts" },
        { icon: AttachMoneyIcon, text: "Track expenses" },
        { icon: CheckIcon, text: "Settle debts easily" },
    ];
    ...
    const handleNext = () => {
        router.push('/onboarding/currency-ai');
    };
    ...
    return (
        <AnimatedContainer>
            ...
            >
                ...
                <MainIconContainer>
                    <IconBackground>
                        <GroupIcon sx={{ fontSize: 48, color: '#ffffff' }} />
                    </IconBackground>
                    <IconPulse />
                </MainIconContainer>
                ...
                <Box sx={{ mb: 4 }}>
                    <GradientTitle>
                        Group <span className="gradient-text">Expenses</span>
                    </GradientTitle>
                ...
                <Box sx={{ mb: 6 }}>
                    ...
                    >
                        Share costs with friends and family effortlessly. Upload a receipt and let everyone see what they owe.
                    </Typography>

                    {/* Feature highlights */}
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1.5 }}>
                        {["Split bills instantly", "Track group spending", "Settle up easily", "Receipt scanning"].map(
                            (feature, index) => (
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1 }}>
                    {[0, 1, 2].map((step) => (
                        <ProgressDot key={step} isActive={step === 0} />
                    ))}
                </Box>
            </Box>
        </AnimatedContainer>
